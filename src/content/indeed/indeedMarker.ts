...
import type { INDEED_AUTO_MARK_TOGGLE_STATE } from "../../types/chrome-storage-local.types";
...
export function setupIndeedMarker() {
  ...
  autoMarkToggleLister(indeedJobObserver, autoMarkState.indeed);
  toggleAutoMarkOnShiftE<INDEED_AUTO_MARK_TOGGLE_STATE>(
    "indeedAutoMarkToggleState"
  );
}
